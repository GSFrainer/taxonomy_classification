...
do
    ...
    do
        ...
        # echo "$splitter,$level,$start_time,$test_time,$end_time" >> feature_classifier_results.txt
        echo "./$splitter/$level/results" >> a.txt
    done
done